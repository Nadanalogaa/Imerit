...
class CandidateOtpPage extends ConsumerStatefulWidget {
  ...
  final String email;
  final String mode; // 'register' or 'login'

  @override
  ConsumerState<CandidateOtpPage> createState() => _CandidateOtpPageState();
}

class _CandidateOtpPageState extends ConsumerState<CandidateOtpPage> {
  ...
  void initState() {
    super.initState();
    _demoCode = OtpService.active(widget.email);
  }
