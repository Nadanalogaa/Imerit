        ...
        <div className="mt-3 flex flex-wrap justify-center gap-2 sm:justify-start">
          ...
          {value && (
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-full border border-zinc-200 px-4 py-1.5 text-xs font-semibold text-rose-600 transition hover:bg-rose-50 dark:border-zinc-700 dark:hover:bg-rose-500/10"
            >
              <Trash2 size={13} />
              Remove
            </button>
