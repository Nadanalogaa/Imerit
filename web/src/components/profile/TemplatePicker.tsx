    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-5">
        {TEMPLATE_META.map((m) => {
          ...
          return (
            ...
            >
              {/* Mini preview */}
              <div className="relative h-32 overflow-hidden border-b border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-950">
                <div
      ...
      {selected ? (
        <div className="flex flex-col gap-2.5">
          ...
          <div className="overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-2xl shadow-zinc-200/40 dark:border-zinc-800 dark:shadow-black/40">
