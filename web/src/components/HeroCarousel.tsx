...
function RoleCard({ icon, title, tagline, bullets, ctaTo, ctaLabel, signInTo, tone }: RoleCardProps) {
 ...
 <li
 key={i}
 className="inline-flex items-center gap-1.5 rounded-full bg-zinc-50 px-3 py-1 text-[12px] font-semibold text-zinc-700 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300"
 >
 {b.icon} {b.label}
 </li>
 ))}
