...
export function SignInMenu() {
 ...
 {open && (
 <div className="absolute right-0 z-50 mt-2 w-72 origin-top-right overflow-hidden rounded-2xl bg-white shadow-2xl dark:bg-zinc-900">
 <Section
...
function Section({
 ...
 to={loginTo}
 onClick={onClose}
 className="flex-1 rounded-xl px-3 py-2 text-center text-sm font-semibold text-zinc-700 transition hover:bg-zinc-50 dark:border-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-800"
 >
 Sign in
 </Link>
 <Link
