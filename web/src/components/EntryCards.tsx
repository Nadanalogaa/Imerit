...
export function EntryCards() {
 ...
 <Link
 to="/candidate"
 className="group relative overflow-hidden rounded-3xl bg-white p-6 md:p-8 shadow-[0_4px_16px_rgba(15,23,42,0.06)] dark:shadow-[0_4px_16px_rgba(0,0,0,0.35)] transition hover:-translate-y-1 hover:shadow-2xl hover:shadow-brand-500/10 dark:bg-zinc-900"
 >
 ...
 <Link
 to="/employer"
 className="group relative overflow-hidden rounded-3xl bg-white p-6 md:p-8 shadow-[0_4px_16px_rgba(15,23,42,0.06)] dark:shadow-[0_4px_16px_rgba(0,0,0,0.35)] transition hover:-translate-y-1 hover:shadow-2xl hover:shadow-sky-500/10 dark:bg-zinc-900"
 >
