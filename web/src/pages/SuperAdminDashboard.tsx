...
export function SuperAdminDashboard() {
 ...
 let alive = true;
 Promise.all([adminApi.stats(), adminApi.trends()])
 .then(([s, t]) => { if (alive) { setStats(s); setTrends(t); } })
 .catch((err) => {
 ...
 className="group flex items-center gap-4 rounded-3xl border border-violet-200 bg-gradient-to-r from-violet-50 to-fuchsia-50 p-5 shadow-[0_4px_16px_rgba(15,23,42,0.06)] dark:shadow-[0_4px_16px_rgba(0,0,0,0.35)] transition hover:shadow-xl dark:border-violet-500/30 dark:from-violet-500/10 dark:to-fuchsia-500/5"
 >
 ...
 className="group flex items-center gap-4 rounded-3xl border border-amber-200 bg-gradient-to-r from-amber-50 to-yellow-50 p-5 shadow-[0_4px_16px_rgba(15,23,42,0.06)] dark:shadow-[0_4px_16px_rgba(0,0,0,0.35)] transition hover:shadow-xl dark:border-amber-500/30 dark:from-amber-500/10 dark:to-yellow-500/5"
 >
 ...
 {/* Top metrics — unified StatTile shared with Admin dashboard.
 Each is a clickable Link with a 7-day trend sparkline. */}
