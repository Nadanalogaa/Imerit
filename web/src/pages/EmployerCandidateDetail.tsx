...
export function EmployerCandidateDetail() {
 ...
 <Link to="/employer/candidates" className="mb-6 inline-flex items-center gap-2 rounded-full px-3 py-1.5 text-xs font-semibold text-zinc-700 transition hover:bg-zinc-100 dark:border-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-800">
 ...
 className="rounded-2xl bg-white px-6 py-2.5 text-sm font-semibold text-zinc-700 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-200"
 >
 Back to list
 </Link>
 <Link
 ...
 <header className="sticky top-16 z-30 -mx-5 mb-6 flex flex-wrap items-center justify-between gap-3 border-b border-zinc-200/60 bg-zinc-50/80 px-5 py-3 backdrop-blur-xl /60 dark:bg-zinc-950/80">
 <Link to="/employer/candidates" className="inline-flex items-center gap-2 rounded-full px-3 py-1.5 text-xs font-semibold text-zinc-700 transition hover:bg-zinc-100 dark:border-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-800">
