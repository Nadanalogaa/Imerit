...
export function EmployerCandidateDetail() {
 ...
 <Link to="/employer/candidates" className="mb-6 inline-flex items-center gap-2 rounded-full px-3 py-1.5 text-lg font-semibold text-zinc-700 transition hover:bg-zinc-100 dark:border-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-800">
