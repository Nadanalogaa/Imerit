...
export function EmployerOtp() {
 ...
 inputMode="numeric"
 maxLength={1}
 className="h-14 w-12 rounded-lg bg-white text-center text-xl font-semibold text-zinc-900 focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-500/20 dark:bg-zinc-950 dark:text-zinc-100 sm:w-14 border border-zinc-200 dark:border-zinc-800"
 />
 ))}
 </div>
