...
export function SubscriptionPlans() {
 ...
 animate={{ opacity: 1, y: 0 }}
 className="overflow-hidden rounded-3xl border-2 border-brand-300 bg-gradient-to-br from-brand-50 via-white to-amber-50 p-6 md:p-8 shadow-2xl shadow-brand-500/10 dark:border-brand-500/40 dark:from-brand-500/10 dark:via-zinc-900 dark:to-amber-500/5"
 >
