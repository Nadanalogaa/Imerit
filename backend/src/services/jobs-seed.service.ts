...
const SEED_JOBS: JobSeed[] = [
  ...
  { employerName: "Zoho Trichy", title: "AI/ML Internship — 6 months", description: "6-month research internship working on multilingual NLP for Indian languages. Stipend ₹35K/month. Final-year B.Tech / M.Tech students preferred. Conversion based on performance.", location: "Srirangam, Tiruchirappalli", districtId: "tiruchirappalli", talukId: "tiruchirappalli_srirangam", lat: 10.8589, lng: 78.6890, field: JobField.IT, type: JobType.INTERNSHIP_TRAINING, experience: JobExperience.FRESHER, salaryRange: "₹35K / month", skills: ["Python", "PyTorch", "NLP", "Research"], postedDaysAgo: 7 },
